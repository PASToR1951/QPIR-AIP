      ...
      <AnimatePresence>
        {!isOnline && (
          <motion.div
            ...
            className="fixed inset-0 z-[200] bg-slate-50 dark:bg-dark-base flex flex-col items-center justify-center p-6 overflow-hidden font-sans text-slate-900 dark:text-slate-100 select-none group/screen"
          >
            {/* Base gradient */}
            ...
            <div className="relative z-10 flex flex-col items-center text-center max-w-xl w-full px-4">
              ...
              <motion.div
                ...
                className="mb-10"
              >
                <img src="/AIP-PIR-logo.png" alt="AIP-PIR Logo" className="h-24 md:h-28 w-auto drop-shadow-2xl" />
              </motion.div>
              ...
              <motion.div
                ...
                className="bg-white/40 dark:bg-dark-surface/60 backdrop-blur-xl border border-white/40 dark:border-dark-border p-10 md:p-12 rounded-[3.5rem] shadow-2xl shadow-blue-200/20 dark:shadow-blue-900/20 w-full mb-10 relative overflow-hidden group"
              >
                {/* Corner accent */}
