    ...
    <>
      <footer className="mt-auto relative overflow-hidden">
        ...
        <div
          ...
          style={{ backgroundImage: `url('/SDO_Facade.webp')`, backgroundPosition: 'center -170px' }}
        />
        {/* Tint overlay — light: near-white wash, dark: near-black wash */}
        <div className="absolute inset-0 bg-slate-50/90 dark:bg-[#100e0c]/92" />
        <div className="absolute inset-x-0 top-0 h-24 bg-gradient-to-b from-slate-100 dark:from-[#141218] to-transparent pointer-events-none" />
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-12 mb-12">
            ...
            <div className="flex flex-col items-center md:items-start text-center md:text-left lg:col-span-2">
              <div className="flex items-center gap-4 mb-6">
                <a href="#" onClick={(e) => e.preventDefault()} className="transition-transform hover:scale-105">
                  <img src={appLogo} alt="AIP-PIR Logo" className="h-12 w-auto drop-shadow-sm transition-all duration-300 hover:drop-shadow-md" />
                </a>
            ...
            <div className="flex flex-col items-center md:items-start text-center md:text-left">
              ...
              <div className="space-y-4">
                ...
                <div className="flex flex-col gap-1 items-center md:items-start">
                  <span className="text-xs font-semibold text-slate-400 dark:text-slate-500 tracking-wider uppercase flex items-center gap-1.5">
                    <Phone size={16} className="text-slate-400 dark:text-slate-500" /> Phone Numbers
                  </span>
