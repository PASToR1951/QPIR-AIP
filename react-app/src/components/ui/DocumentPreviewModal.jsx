            ...
            {isOpen && (
                <div className="fixed inset-0 z-[100] flex flex-col items-center justify-center p-4 md:p-8 print:static print:block print:p-0 print:z-auto">
                    ...
                    <motion.div
                        ...
                        className={`relative w-full ${landscape ? 'max-w-[1200px]' : 'max-w-5xl'} h-full flex flex-col bg-slate-50 dark:bg-dark-base rounded-[2.5rem] shadow-2xl border border-white/20 overflow-hidden pointer-events-auto print:static print:max-w-none print:w-full print:h-auto print:flex-none print:rounded-none print:shadow-none print:bg-white print:border-0 print:overflow-visible`}
                    ...
                    >
                        ...
                        <div className="flex-1 overflow-y-auto overflow-x-auto p-6 md:p-12 scrollbar-thin scrollbar-thumb-slate-200 dark:scrollbar-thumb-dark-border scrollbar-track-transparent print:overflow-visible print:p-0 print:flex-none print:h-auto">
                            <div className={`${landscape ? 'max-w-[297mm]' : 'max-w-[210mm]'} mx-auto print:max-w-none`}>
                                <div className={`bg-white text-black shadow-xl ring-1 ring-slate-900/5 rounded-sm p-8 md:p-12 print:p-0 print:shadow-none print:m-0 print:ring-0 ${landscape ? 'min-h-[210mm]' : 'min-h-[297mm]'} print:min-h-0`}>
                                    {children}
                                </div>
