            ...
            <div className="relative z-10 container mx-auto px-6 flex flex-col items-center justify-center flex-1 py-10 md:py-16 lg:py-20">
                <div className="max-w-xl md:max-w-2xl lg:max-w-3xl w-full">
                    ...
                    <button
                        ...
                        className="inline-flex items-center gap-2 text-xs md:text-sm font-bold text-slate-400 hover:text-slate-700 transition-colors uppercase tracking-wider mb-6 md:mb-10"
                    >
                    ...
                    <div className="bg-white/90 backdrop-blur-sm rounded-2xl lg:rounded-3xl border border-slate-200/80 shadow-sm p-6 md:p-8 lg:p-10 mb-5 md:mb-6">
                        <div className="flex items-start gap-4 lg:gap-5 mb-5 md:mb-6">
                            ...
                            <div className="min-w-0 flex-1">
                                <p className="text-[10px] md:text-xs font-black uppercase tracking-[0.15em] text-slate-400 mb-1 md:mb-1.5">
                                    {theme === 'blue' ? 'Quarterly PIR' : 'Annual AIP'} for
                                </p>
                                <h2 className="text-xl md:text-2xl lg:text-3xl font-extrabold text-slate-900 tracking-tight leading-snug break-words">
                                    {selected}
                                </h2>
                            </div>
                        </div>
                        ...
                        {hasDraft && draftInfo && isDraftMatch && (
                            <div className="flex items-center gap-3 px-4 py-3 md:px-5 md:py-3.5 bg-amber-50 border border-amber-200 rounded-xl md:rounded-2xl mb-5 md:mb-6">
                        ...
                        <div className="border-t border-slate-100 pt-5 md:pt-6">
                            <p className="text-base md:text-lg font-bold text-slate-700 mb-1">How would you like to work?</p>
                            <p className="text-sm md:text-base text-slate-400">Pick a layout that fits your style.</p>
                        </div>
                    </div>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 md:gap-5">
                        ...
                        <button
                            ...
                            className={`group bg-white/90 backdrop-blur-sm rounded-2xl lg:rounded-3xl border-2 border-slate-100 ${c.modeBorder} p-6 md:p-7 lg:p-8 text-left transition-all duration-200 shadow-sm hover:shadow-lg active:scale-[0.97] overflow-hidden relative`}
                        >
                            ...
                            <div className="flex items-center gap-3 md:gap-4 mb-5 md:mb-6">
                                ...
                                <div>
                                    <h3 className={`text-lg md:text-xl font-black text-slate-900 leading-none transition-colors ${c.modeTitleHover}`}>Step-by-Step</h3>
                                    <p className="text-xs md:text-sm text-slate-400 font-medium mt-1">Guided wizard</p>
                                </div>
                            </div>
                            ...
                            <ul className="space-y-2 md:space-y-2.5 mb-6 md:mb-7">
                                {['One section at a time', 'Progress tracking', 'Great for first-timers'].map(f => (
                                    <li key={f} className="flex items-center gap-2.5 text-xs md:text-sm text-slate-500">
                        ...
                        <button
                            ...
                            className="group bg-white/90 backdrop-blur-sm rounded-2xl lg:rounded-3xl border-2 border-slate-100 hover:border-slate-200 hover:shadow-lg p-6 md:p-7 lg:p-8 text-left transition-all duration-200 shadow-sm active:scale-[0.97] overflow-hidden relative"
                        >
                            <div className="absolute top-0 right-0 w-40 h-40 lg:w-52 lg:h-52 bg-slate-100 rounded-full blur-3xl opacity-0 group-hover:opacity-100 transition-opacity duration-500 pointer-events-none -mr-12 -mt-12" />

                            {/* Icon row */}
                            <div className="flex items-center gap-3 md:gap-4 mb-5 md:mb-6">
                                <div className="w-12 h-12 md:w-14 md:h-14 rounded-xl md:rounded-2xl flex items-center justify-center border transition-all duration-200 group-hover:scale-105 bg-gradient-to-br from-slate-50 to-slate-100 text-slate-500 border-slate-200 group-hover:from-slate-100 group-hover:to-slate-200 shadow-sm">
                                    <svg xmlns="http://www.w3.org/2000/svg" className="w-5 h-5 md:w-6 md:h-6" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
                                ...
                                <div>
                                    <h3 className="text-lg md:text-xl font-black text-slate-900 leading-none group-hover:text-slate-700 transition-colors">Full Form</h3>
                                    <p className="text-xs md:text-sm text-slate-400 font-medium mt-1">Classic layout</p>
                                </div>
                            </div>
                            ...
                            <ul className="space-y-2 md:space-y-2.5 mb-6 md:mb-7">
                                {['All sections at once', 'Quick scroll navigation', 'Familiar paper layout'].map(f => (
                                    <li key={f} className="flex items-center gap-2.5 text-xs md:text-sm text-slate-500">
                                        <svg xmlns="http://www.w3.org/2000/svg" className="w-3.5 h-3.5 md:w-4 md:h-4 shrink-0" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round">
                                            <path d="M20 6 9 17l-5-5" className="text-slate-400" />
                                        </svg>
                                        {f}
                                    </li>
                                ))}
                            ...
                            {/* CTA */}
                            <div className="inline-flex items-center gap-2 text-xs md:text-sm font-bold uppercase tracking-widest px-4 py-2.5 rounded-xl bg-slate-100 text-slate-500 group-hover:bg-slate-200 transition-colors">
                                <span>Open Form</span>
                                <svg xmlns="http://www.w3.org/2000/svg" width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
                                    <path d="M5 12h14" /><path d="m12 5 7 7-7 7" />
                                </svg>
