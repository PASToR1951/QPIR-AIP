    ...
    return (
        <div className="animate-in fade-in slide-in-from-bottom-4 duration-200">
            <SectionHeader
                ...
                appMode={appMode}
            />
            <div className="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-6 bg-slate-50 dark:bg-dark-base p-6 rounded-2xl border border-slate-200 dark:border-dark-border shadow-sm">
                {budgetLocked
