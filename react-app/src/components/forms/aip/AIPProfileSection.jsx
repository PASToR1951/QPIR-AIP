...
export default React.memo(function AIPProfileSection({
    ...
    const targetOptions = (OUTCOME_TARGETS[outcome] ?? []).map(t => ({
        value: t.description,
    ...
    return (
        <>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-6">
                ...
                <Select theme="pink" label="Outcome Target" placeholder="Select a Target..." options={targetOptions} value={selectedTarget} onChange={(e) => setSelectedTarget(e.target.value)} disabled={!outcome} />
