...
export default function AdminPrograms() {
  ...
  const handleAdd = async () => {
    ...
    try {
      ...
      setAddOpen(false); setProgramForm({ title: '', abbreviation: '', division: '', school_level_requirement: 'Both' }); fetchAll(); showToast('Program added successfully.');
    } catch (e) {
      ...
      <div className="space-y-4">
        ...
        <div className="flex flex-col gap-2">
          <div className="flex items-center gap-2">
            ...
            <button onClick={() => { setAddOpen(true); setProgramForm({ title: '', abbreviation: '', division: '', school_level_requirement: 'Both' }); }}
