export const schoolRoleConfig = {
  ...
  tasks: [
    ...
    },
    {
      ...
      description: 'Open the quarterly PIR form tied to your submitted AIP.',
      route: '/pir',
      ...
      tourSteps: [
        {
          ...
          description: 'Quarterly reports start here. Choose the program you are reporting on — only programs with a submitted AIP are available for PIR filing.',
          placement: 'bottom',
        },
      ],
    },
    {
      ...
      description: 'Choose a program so the PIR form can load planned activities.',
      route: '/pir',
      ...
      tourSteps: [
        {
          ...
          description: 'Select the program for this quarter. The PIR will pull in the activities and targets from that program\'s approved AIP.',
          placement: 'bottom',
      ...
      tourSteps: [
        {
          ...
          description: 'Use this final area to preview your quarterly report before submitting it for review. Check accomplishments, spending, and action items carefully.',
          placement: 'top',
          prerequisiteTarget: 'pir-form-active',
