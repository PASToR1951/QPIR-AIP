...
import SDSDashboard from './SDSDashboard.jsx';
  ...
  return (
    <div className="min-h-screen bg-slate-50 dark:bg-dark-base flex flex-col font-sans">
        ...
        <div className="max-w-6xl mx-auto px-4 h-14 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div className="flex flex-col">
              ...
              <span className="text-[9px] font-black text-purple-600 tracking-[0.2em] uppercase mt-0.5 select-none">
                SDS Review Portal
              </span>
            </div>
          </div>
      ...
      <main className="flex-1 w-full max-w-6xl mx-auto px-4 py-8">
        <Routes>
          <Route index element={<SDSDashboard />} />
        </Routes>
      </main>
    </div>
  );
